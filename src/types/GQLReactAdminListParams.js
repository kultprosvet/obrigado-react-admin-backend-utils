...
var GQLReactAdminListParams = /** @class */ (function () {
    function GQLReactAdminListParams() {
    }
    __decorate([
        type_graphql_1.Field(function (type) { return GQLReactAdminPagination_1.GQLReactAdminPagination; })
    ], GQLReactAdminListParams.prototype, "pagination", void 0);
    __decorate([
        type_graphql_1.Field(function (type) { return GQLReactAdminSort_1.GQLReactAdminSort; })
    ], GQLReactAdminListParams.prototype, "sort", void 0);
    __decorate([
        type_graphql_1.Field(function (type) { return [GQLReactAdminFilterParam_1.GQLReactAdminFilterParam]; }, { nullable: true })
    ], GQLReactAdminListParams.prototype, "filter", void 0);
    GQLReactAdminListParams = __decorate([
        type_graphql_1.InputType('ReactAdminListParams')
    ], GQLReactAdminListParams);
    return GQLReactAdminListParams;
}());
exports.GQLReactAdminListParams = GQLReactAdminListParams;
